class Student:
    ...
    # Construtor to set al the values
    def __str__(self):
        return f"=============== Student {self.g_num} =============== \nName: {self.name}\nG_Num: G{str(self.g_num).zfill(5)}\nMajor:{self.major}\nEnrollment_Active = {self.enrolled_status}\nCredits = {self.credits}\nGPA = {self.get_gpa():.2f}"
        
    # Check if the studene is enrolled or not
